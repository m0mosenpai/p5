...
class Xv6Test(BuildTest, Test):
    ...
    def run(self):
        ...
        print("DEBUG: tester started, timeout: " + str(self.timeout))
        ...
        print("DEBUG: matched_patterns: " + str([pattern for pattern in patterns.keys() if re.search(pattern, captured_text)]))
